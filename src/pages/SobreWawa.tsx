      ...
      <section className="py-24 md:py-32">
        <div className="container max-w-6xl">
          <div className="grid md:grid-cols-12 gap-12 lg:gap-8 items-start">
            ...
            <div className="md:col-span-6 md:col-start-7 lg:col-span-6 lg:col-start-7 space-y-4 text-lg md:text-xl text-muted-foreground leading-relaxed animate-fade-up animation-delay-200 text-balance">
              <p>
      ...
      <section className="py-24 md:py-32 border-t border-border/50">
        <div className="container max-w-6xl">
          <div className="grid md:grid-cols-12 gap-12 lg:gap-8 items-start">
            ...
            <div className="md:col-span-6 md:col-start-7 lg:col-span-6 lg:col-start-7 space-y-4 text-lg md:text-xl text-muted-foreground leading-relaxed">
              <p>
        ...
        <div className="container max-w-6xl">
          <div className="grid md:grid-cols-12 gap-12 lg:gap-8 items-start">
            ...
            <div className="md:col-span-6 md:col-start-7 lg:col-span-6 lg:col-start-7 space-y-12">
              <div className="space-y-4 text-lg md:text-xl text-muted-foreground leading-relaxed mb-16">
                <p>
              ...
              <Accordion type="single" collapsible className="w-full space-y-0 border-t border-black">
                ...
                <AccordionItem value="escucha" className="border-b border-black py-4">
                  <AccordionTrigger className="hover:no-underline py-4 group">
                    <div className="flex items-center justify-between w-full text-left">
                      <h4 className="text-lg md:text-xl font-sans font-medium uppercase tracking-wide">01. ESCUCHA</h4>
                ...
                <AccordionItem value="estrategia" className="border-b border-black py-4">
                  <AccordionTrigger className="hover:no-underline py-4 group">
                    <div className="flex items-center justify-between w-full text-left">
                      <h4 className="text-lg md:text-xl font-sans font-medium uppercase tracking-wide">02. ESTRATEGIA</h4>
                      <div className="flex shrink-0 ml-4">
                        <Plus className="w-6 h-6 text-black transition-all duration-300 group-data-[state=open]:hidden" strokeWidth={1.5} />
                        <Minus className="w-6 h-6 text-black transition-all duration-300 hidden group-data-[state=open]:block" strokeWidth={1.5} />
                      </div>
                ...
                <AccordionItem value="implementacion" className="border-b border-black py-4">
                  <AccordionTrigger className="hover:no-underline py-4 group">
                    <div className="flex items-center justify-between w-full text-left">
                      <h4 className="text-lg md:text-xl font-sans font-medium uppercase tracking-wide">03. IMPLEMENTACIÓN</h4>
                      <div className="flex shrink-0 ml-4">
                        <Plus className="w-6 h-6 text-black transition-all duration-300 group-data-[state=open]:hidden" strokeWidth={1.5} />
                        <Minus className="w-6 h-6 text-black transition-all duration-300 hidden group-data-[state=open]:block" strokeWidth={1.5} />
                      </div>
                ...
                <AccordionItem value="acompanamiento" className="border-b border-black py-4">
                  <AccordionTrigger className="hover:no-underline py-4 group">
                    <div className="flex items-center justify-between w-full text-left">
                      <h4 className="text-lg md:text-xl font-sans font-medium uppercase tracking-wide">04. ACOMPAÑAMIENTO</h4>
                      <div className="flex shrink-0 ml-4">
                        <Plus className="w-6 h-6 text-black transition-all duration-300 group-data-[state=open]:hidden" strokeWidth={1.5} />
                        <Minus className="w-6 h-6 text-black transition-all duration-300 hidden group-data-[state=open]:block" strokeWidth={1.5} />
                      </div>
