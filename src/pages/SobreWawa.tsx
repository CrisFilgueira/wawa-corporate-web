...
const SobreWawa = () => {
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Por qué nace Wawa */}
      <section className="pt-4 pb-24 md:pt-8 md:pb-32">
      ...
      <section className="py-24 md:py-32 border-t border-border/50">
        <div className="container max-w-6xl">
          <div className="grid md:grid-cols-12 gap-12 lg:gap-8 items-start">
            ...
            <div className="md:col-span-6 md:col-start-7 lg:col-span-6 lg:col-start-7 space-y-4 text-base leading-relaxed text-foreground font-light [&_*]:font-light">
              <p>
        ...
        <div className="container max-w-6xl">
          <div className="grid md:grid-cols-12 gap-12 lg:gap-8 items-start">
            ...
            <div className="md:col-span-6 md:col-start-7 lg:col-span-6 lg:col-start-7 space-y-12">
              <div className="space-y-4 text-base leading-relaxed text-foreground font-light [&_*]:font-light mb-16">
                <p>
              ...
              <Accordion type="single" collapsible className="w-full space-y-0 border-t border-black">
                ...
                <AccordionItem value="escucha" className="border-b border-black py-4">
                  ...
                  <AccordionContent className="pt-2 pb-6">
                    <div className="space-y-4 text-base leading-relaxed text-foreground font-light [&_*]:font-light">
                      <p>
