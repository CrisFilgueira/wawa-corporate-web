...
const Servicios = () => {
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="pb-[var(--space-section-mobile)] md:pb-[var(--space-section-desktop)] pt-6 md:pt-10">
              ...
              <AccordionTrigger className="hover:no-underline py-4 group">
                <div className="flex items-start md:items-center justify-between w-full text-left">
                  <div className="flex flex-col gap-4 w-full">
                    ...
                    <p className="text-lg md:text-xl font-sans font-light text-black leading-relaxed max-w-2xl mt-2">
              ...
              <AccordionContent className="pt-6">
                <div className="grid md:grid-cols-2 gap-8">
                  ...
                  <div className="space-y-6">
                    <p className="text-lg md:text-xl font-sans font-light text-black leading-relaxed">
                    ...
                    <div>
                      ...
                      <ul className="text-lg md:text-xl font-sans font-light text-muted-foreground leading-relaxed space-y-1">
              ...
              <AccordionContent className="pt-6">
                <div className="grid md:grid-cols-2 gap-8">
                  ...
                  <div className="space-y-6">
                    ...
                    <p className="text-lg md:text-xl font-sans font-light leading-relaxed text-black">
                    ...
                    <div>
                      ...
                      <Accordion type="single" collapsible className="w-full space-y-0 border-t border-black">
                        <AccordionItem value="estrategia-web" className="border-b border-black py-4">
                          <AccordionTrigger className="hover:no-underline py-4 group">
                            <div className="flex items-center justify-between w-full text-left">
                              <h4 className="text-lg md:text-xl font-sans font-medium">01. Estrategia web</h4>
                              <div className="flex shrink-0 ml-4">
                          ...
                          <AccordionContent className="pt-2 pb-6">
                            <p className="text-lg md:text-xl font-sans font-light text-muted-foreground leading-relaxed bg-muted/30 p-3 border-l-2 border-primary">
                        ...
                        <AccordionItem value="diseno" className="border-b border-black py-4">
                          <AccordionTrigger className="hover:no-underline py-4 group">
                            <div className="flex items-center justify-between w-full text-left">
                              <h4 className="text-lg md:text-xl font-sans font-medium">02. Diseño</h4>
                              <div className="flex shrink-0 ml-4">
                                <Plus className="w-5 h-5 text-black transition-all duration-300 group-data-[state=open]:hidden" strokeWidth={1} />
                                <Minus className="w-5 h-5 text-black transition-all duration-300 hidden group-data-[state=open]:block" strokeWidth={1} />
                              </div>
                        ...
                        <AccordionItem value="desarrollo" className="border-b border-black py-4">
                          <AccordionTrigger className="hover:no-underline py-4 group">
                            <div className="flex items-center justify-between w-full text-left">
                              <h4 className="text-lg md:text-xl font-sans font-medium">03. Desarrollo vibe coding</h4>
                              <div className="flex shrink-0 ml-4">
                                <Plus className="w-5 h-5 text-black transition-all duration-300 group-data-[state=open]:hidden" strokeWidth={1} />
                                <Minus className="w-5 h-5 text-black transition-all duration-300 hidden group-data-[state=open]:block" strokeWidth={1} />
                              </div>
                        ...
                        <AccordionItem value="entrega" className="border-b border-black py-4">
                          <AccordionTrigger className="hover:no-underline py-4 group">
                            <div className="flex items-center justify-between w-full text-left">
                              <h4 className="text-lg md:text-xl font-sans font-medium">04. Entrega</h4>
                              <div className="flex shrink-0 ml-4">
                                <Plus className="w-5 h-5 text-black transition-all duration-300 group-data-[state=open]:hidden" strokeWidth={1} />
                                <Minus className="w-5 h-5 text-black transition-all duration-300 hidden group-data-[state=open]:block" strokeWidth={1} />
                              </div>
                          ...
                          <AccordionContent className="pt-2 pb-6">
                            <p className="text-lg md:text-xl font-sans font-light text-muted-foreground leading-relaxed">
                        ...
                        <AccordionItem value="que-incluye" className="border-b border-black py-4">
                          <AccordionTrigger className="hover:no-underline py-4 group">
                            <div className="flex items-center justify-between w-full text-left">
                              <h4 className="text-lg md:text-xl font-sans font-medium">Qué incluye</h4>
                              <div className="flex shrink-0 ml-4">
                                <Plus className="w-5 h-5 text-black transition-all duration-300 group-data-[state=open]:hidden" strokeWidth={1} />
                                <Minus className="w-5 h-5 text-black transition-all duration-300 hidden group-data-[state=open]:block" strokeWidth={1} />
                              </div>
      ...
      <section className="py-[var(--space-section-mobile)] md:py-[var(--space-section-desktop)] bg-subtle">
        <div className="container max-w-3xl">
          ...
          <div className="space-y-6 md:space-y-8 text-center max-w-2xl mx-auto">
            <p className="text-lg md:text-xl font-sans font-light tracking-wide leading-relaxed text-foreground/80 text-balance">
            ...
            <p className="text-lg md:text-xl font-sans font-medium tracking-wide leading-relaxed text-foreground/90 text-balance mt-8">
