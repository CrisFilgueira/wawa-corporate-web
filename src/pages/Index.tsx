        ...
        <div className="container px-6 md:px-12">
          <div className="max-w-5xl mx-auto space-y-12">
            <div className="w-full">
              ...
              <div className="space-y-4 text-lg md:text-xl font-sans font-light tracking-wide leading-relaxed text-foreground/80">
            ...
            <div className="grid md:grid-cols-2 gap-x-12 gap-y-8 mt-12">
              <ul className="space-y-6 text-lg md:text-xl font-sans text-foreground/80 list-none p-0">
        ...
        <div className="grid md:grid-cols-2 w-full items-center">
          <div className="flex flex-col justify-center p-6 md:p-24 lg:p-32 order-2 md:order-1">
            <div className="max-w-xl mx-auto space-y-8">
              ...
              <ul className="space-y-6 text-lg md:text-xl font-sans text-foreground/80 border-l px-6 border-black/10 text-balance list-none py-2 pb-8">
                <li className="space-y-1">
                  <strong className="text-foreground font-medium block">Automatizamos el ciclo comercial y operativo.</strong>
                  <span className="text-lg md:text-xl leading-relaxed opacity-80 block pt-1">Integramos cada paso del cliente, desde la captación y atención al lead hasta el cierre.</span>
                </li>
                <li className="space-y-1 mt-6">
                  <strong className="text-foreground font-medium block">Implementamos sistemas autónomos.</strong>
                  <span className="text-lg md:text-xl leading-relaxed opacity-80 block pt-1">La tecnología ejecuta el volumen; tú supervisas la estrategia.</span>
                </li>
              </ul>

              <p className="text-lg md:text-xl font-sans tracking-wide leading-relaxed text-foreground/90 text-balance mt-4">
              ...
              <Accordion type="single" collapsible className="w-full space-y-8 md:space-y-10">
                {[
                  ...
                  <AccordionItem key={service.id} value={service.id} className="border-none">
                    ...
                    <AccordionContent className="text-white text-lg md:text-xl font-sans font-light tracking-wide leading-relaxed text-balance pt-6 pb-2 max-w-3xl">
